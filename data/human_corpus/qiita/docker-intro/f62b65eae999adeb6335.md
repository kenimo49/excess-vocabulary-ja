...
/
# rustup toolchain list
1.74.0-aarch64-unknown-linux-gnu (default)
# rustup override list
no overrides
```

## R1, RULE - Use a stable compilation toolchain
...
# rustup run nightly cargo fmt
error: toolchain 'nightly-aarch64-unknown-linux-gnu' is not installed
```
これではだめみたい。
