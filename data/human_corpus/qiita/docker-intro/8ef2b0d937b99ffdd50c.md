...
```docker:bash
root@ffc652d1f3f8:/r4cppp# vi main.rs
root@ffc652d1f3f8:/r4cppp# rustc main.rs
root@ffc652d1f3f8:/r4cppp# ./main
Hello world!
```
...
```docker:bash
root@ffc652d1f3f8:/r4cppp# vi main2.rs
root@ffc652d1f3f8:/r4cppp# rustc main2.rs
root@ffc652d1f3f8:/r4cppp# ./main2
Hello world!
```
...
```docker:bash
root@ffc652d1f3f8:/r4cppp# vi main3.rs
root@ffc652d1f3f8:/r4cppp# rustc main3.rs
root@ffc652d1f3f8:/r4cppp# ./main3
Hello world!
```
# 参考資料(reference)
