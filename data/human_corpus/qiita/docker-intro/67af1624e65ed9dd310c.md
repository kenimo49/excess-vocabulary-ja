...
Issuing Committee: Functional Safety Committee
Rationale: Rust is a new general purpose programming language which combines high run time efficiency and modern design patterns with rigorous compile time checks.
